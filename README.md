...
| 🪧 Vitrine Dev |     |
| ------------- | --- |
| ✨ Nome        | **My Gallery** - devChallenges |
| 🏷️ Tecnologias | HTML, Sass, JavaScript, Gulp |
| 🚀 URL Front-end | [**Acesse o site**](https://araujowebdev.github.io/My-Gallery---devChallenges/) ou veja como rodar localmente no item [**⚙️ Como usar**](#howto) |
| 🔥 Desafio     | [devChallenges - My Gallery](https://devchallenges.io/challenges/gcbWLxG6wdennelX7b8I) |

![](https://raw.githubusercontent.com/araujowebdev/My-Gallery---devChallenges/main/dist/assets/imgs/page-view-my-gallery.jpg)
...
```
git clone https://github.com/araujowebdev/My-Gallery---devChallenges.git
```
...
```
[00:00:00] Using gulpfile ~/My-Gallery---devChallenges/gulpfile.js
